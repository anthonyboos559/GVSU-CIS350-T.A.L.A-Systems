...
class Database:
    def __init__(self):
        self._connection = sqlite3.connect("../data/T.A.L.A. System Database")
    ...
    def _load_member_table(self):
        ...
        with open('../data/memberOriginalData', 'r') as mem_file:
    ...
    def _load_employee_table(self):
        ...
        with open('../data/employeeOriginalData', 'r') as empFile:
    ...
    def _load_inventory_table(self):
        ...
        """
        with open('../data/inventoryOriginalData', 'r') as inv_file:
